...
import { RedditPost, YouTubeVideo, QuoraPost, TwitterPost } from '@/types/search'
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs'
import { ArrowUpFromLine, MessageSquare, ExternalLink, Youtube, Share2, ThumbsUp, Twitter } from 'lucide-react'
...
export function SearchResults({ reddit, youtube, quora, twitter }: SearchResultsProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="space-y-4"
    >
      <h2 className="font-lexend text-2xl font-semibold mb-4">Search Results</h2>
